...
$MESSAGE['register']['fields']['gender_b'] = 'Non Binario';
...
/********** Pagine utente **********/
/* Logout Page */
$MESSAGE['logout']['confirmation'] = ', arrivederci.';
$MESSAGE['logout']['greeting'] = 'Crystal Tokyo ti aspetta.';
...
$MESSAGE['interface']['meteo']['status'][5] = 'Temporale';
$MESSAGE['interface']['meteo']['status_img'][0] = '/themes/crystal/imgs/meteo/sole.png';
$MESSAGE['interface']['meteo']['status_img'][1] = '/themes/crystal/imgs/meteo/sole_nuvoloso.png';
$MESSAGE['interface']['meteo']['status_img'][2] = '/themes/crystal/imgs/meteo/nuvoloso.png';
$MESSAGE['interface']['meteo']['status_img'][3] = '/themes/crystal/imgs/meteo/pioggia.png';
$MESSAGE['interface']['meteo']['status_img'][4] = '/themes/crystal/imgs/meteo/pioggia_forte.png';
$MESSAGE['interface']['meteo']['status_img'][5] = '/themes/crystal/imgs/meteo/temporale.png';
...
$MESSAGE['interface']['sheet']['first_login'] = 'Iscrizione';
...
$MESSAGE['interface']['sheet']['box_title']['guild_skills'] = 'Abilità di famiglia';
$MESSAGE['interface']['sheet']['box_title']['background'] = 'Background';
$MESSAGE['interface']['sheet']['box_title']['relationships'] = 'Affetti';
$MESSAGE['interface']['sheet']['box_title']['notes&fato'] = 'Particolari e Note del Fato';
$MESSAGE['interface']['sheet']['box_title']['points'] = 'Affetti';
$MESSAGE['interface']['sheet']['profile']['role'] = 'Incarico utente';
$MESSAGE['interface']['sheet']['profile']['no_race'] = 'sconosciuta';
$MESSAGE['interface']['sheet']['profile']['age'] = 'Et&agrave;';
$MESSAGE['interface']['sheet']['profile']['place'] = 'Nato a';
$MESSAGE['interface']['sheet']['profile']['occupation'] = 'Occupazione';
$MESSAGE['interface']['sheet']['profile']['guild'] = 'Famiglia';
$MESSAGE['interface']['sheet']['profile']['guild_role'] = 'Carica';
$MESSAGE['interface']['sheet']['profile']['job'] = 'Mestiere';
$MESSAGE['interface']['sheet']['profile']['job_role'] = 'Ruolo';
...
$MESSAGE['interface']['sheet']['menu']['history'] = 'Storia';
$MESSAGE['interface']['sheet']['menu']['description'] = 'Dice di s&egrave;';
$MESSAGE['interface']['sheet']['menu']['transictions'] = 'Transazioni';
$MESSAGE['interface']['sheet']['menu']['experience'] = 'Esperienza';
$MESSAGE['interface']['sheet']['menu']['shin'] = 'Shin';
$MESSAGE['interface']['sheet']['menu']['inventory'] = 'Inventario';
$MESSAGE['interface']['sheet']['menu']['equipment'] = 'Equipaggiamento';
$MESSAGE['interface']['sheet']['menu']['skills'] = 'Skills';
$MESSAGE['interface']['sheet']['menu']['gst'] = 'Amministra';
$MESSAGE['interface']['sheet']['menu']['log'] = 'Log';
$MESSAGE['interface']['sheet']['menu']['points'] = 'Log';
$MESSAGE['interface']['sheet']['menu']['friends'] = 'Amici';
$MESSAGE['interface']['sheet']['menu']['off'] = 'Off';
$MESSAGE['interface']['sheet']['modify_form']['last_name'] = 'Cognome';
$MESSAGE['interface']['sheet']['modify_form']['relationships'] = 'Principale';
$MESSAGE['interface']['sheet']['modify_form']['background'] = 'Storia';
$MESSAGE['interface']['sheet']['modify_form']['description'] = 'Dice di s&egrave;';
$MESSAGE['interface']['sheet']['modify_form']['age'] = 'Et&agrave;';
$MESSAGE['interface']['sheet']['modify_form']['place'] = 'Luogo di nascita';
...
$MESSAGE['interface']['sheet']['modify_form']['notorieta'] = 'Notorietà';
$MESSAGE['interface']['sheet']['modify_form']['shin'] = 'Shin';
...
$MESSAGE['interface']['sheet']['modify_form']['volto'] = 'Volto personaggio';
$MESSAGE['interface']['sheet']['modify_form']['off'] = 'Off';
$MESSAGE['interface']['sheet']['modify_form']['friends'] = 'Amici';
$MESSAGE['interface']['sheet']['modify_form']['note_fato'] = 'Note fato';
$MESSAGE['interface']['sheet']['modify_form']['particolari'] = 'Particolari';
...
$MESSAGE['interface']['sheet']['modify_form']['admin']['relationships'] = 'Principale';
$MESSAGE['interface']['sheet']['modify_form']['admin']['age'] = 'Et&agrave;';
$MESSAGE['interface']['sheet']['modify_form']['admin']['place'] = 'Luogo di nascita';
...
$MESSAGE['interface']['sheet']['items']['zaino'] = 'Equipaggiamento';
...
$MESSAGE['interface']['sheet']['items']['list']['stats']['heal'] = 'Recupero salute';
...
$MESSAGE['interface']['sheet']['items']['list']['put_in'] = 'Equipaggia';
...
$MESSAGE['interface']['sheet']['info_skill_cost'] = 'Ogni 5 punti esperienza sarà possibile o incrementare di 1 sola unità un parametro o acquistare/potenziare una skill';
$MESSAGE['interface']['sheet']['avalaible_xp'] = 'Punti esperienza disponibili';
$MESSAGE['interface']['sheet']['avalaible_skill_points'] = 'Punti skill disponibili';
...
$MESSAGE['interface']['messages']['title'] = 'Titolo';
...
$MESSAGE['interface']['messages']['type'][0] = 'OFF-GAME';
$MESSAGE['interface']['messages']['type'][1] = 'ON-GAME';
$MESSAGE['interface']['messages']['type'][2] = 'COMUNICAZIONI';
...
$MESSAGE['interface']['forums']['link']['segnala'] = 'Segnala';
...
/* Anonimi e Giornalisti*/
$MESSAGE['forum']['anon'][0] = 'Non Anonimo';
$MESSAGE['forum']['anon'][1] = 'Anonimo';
$MESSAGE['forum']['giorn'][0] = 'Firma col tuo nome';
$MESSAGE['forum']['giorn'][1] = 'Giornalista generico';
...
$MESSAGE['interface']['forums']['type'][6] = 'Solo mestieri';*/

/* Tipi forum NUOVI*/
$MESSAGE['interface']['forums']['type'][0] = 'ON-GAME';
$MESSAGE['interface']['forums']['type'][1] = 'Role e Quest';
$MESSAGE['interface']['forums']['type'][2] = 'Informazioni';
$MESSAGE['interface']['forums']['type'][3] = 'OFF-GAME';
$MESSAGE['interface']['forums']['type'][4] = ' ' . strtolower($PARAMETERS['names']['race']['sing']) . '';
$MESSAGE['interface']['forums']['type'][5] = ' ' . strtolower($PARAMETERS['names']['guild_name']['sing']) . '';
$MESSAGE['interface']['forums']['type'][6] = 'Mestiere';
$MESSAGE['interface']['forums']['type'][7] = 'Master';
$MESSAGE['interface']['forums']['type'][8] = 'Moderatore';
$MESSAGE['interface']['forums']['type'][9] = 'Guida';
$MESSAGE['interface']['forums']['type'][10] = 'Capogilda';
$MESSAGE['interface']['forums']['type'][11] = 'Capomestiere';
$MESSAGE['interface']['forums']['type'][12] = 'Admin';
...
/*Inclinazioni*/
$MESSAGE['interface']['inclinazioni']['page_name'] = 'Inclinazioni';
$MESSAGE['interface']['inclinazioni']['submit']['pick'] = 'Scegli';
$MESSAGE['interface']['inclinazioni']['submit']['quit'] = 'Uscire';
$MESSAGE['interface']['inclinazioni']['ok_job'] = 'Inclinazione scelta';
$MESSAGE['interface']['inclinazioni']['ok_quit'] = 'Uscita effettuata';
$MESSAGE['interface']['inclinazioni']['job'] = 'Inclinazione';
$MESSAGE['interface']['inclinazioni']['back'] = 'Torna all\'elenco...';
/*Lavoro*/
$MESSAGE['interface']['job']['page_name'] = 'Lavoro';
$MESSAGE['interface']['job']['statuto'] = 'Statuto';
...
$MESSAGE['interface']['job']['roles_title']['plur'] = 'Cariche';
$MESSAGE['interface']['job']['roles_title']['sing'] = 'Carica';
$MESSAGE['interface']['job']['statuto'] = 'Statuto';
$MESSAGE['interface']['job']['members'] = 'Affiliati';
$MESSAGE['interface']['job']['member'] = 'Affiliato';
/*Gilde*/
...
$MESSAGE['interface']['guilda']['statuto'] = 'Statuto';
...
/*Amministrazione mestieri*/
$MESSAGE['interface']['adm_jobs']['page_name'] = 'Amministrazione';
$MESSAGE['interface']['adm_jobs']['back'] = 'Torna al pannello';
$MESSAGE['interface']['adm_jobs']['no_adm'] = 'Non hai i permessi per amministrare un';
$MESSAGE['interface']['adm_guilds']['freelance'] = 'Indipendente';
$MESSAGE['interface']['adm_jobs']['new_member'] = 'Nomina nuovi';
$MESSAGE['interface']['adm_jobs']['fire_member'] = 'Espelli';
$MESSAGE['interface']['adm_jobs']['hire'] = 'Assumi';
$MESSAGE['interface']['adm_jobs']['fire'] = 'Licenzia';
$MESSAGE['interface']['adm_jobs']['quit'] = 'Dimissioni';
$MESSAGE['interface']['adm_jobs']['ok_fire'] = 'Licenziamento avvenuto';
$MESSAGE['interface']['adm_jobs']['cannot_hire'] = 'ha già il massimo numero di affiliazioni consentito, operare prima un licenziamento.';
$MESSAGE['interface']['adm_jobs']['ok_hire'] = 'Assunzione avvenuta';
/*Mercato*/
...
$MESSAGE['interface']['administration']['guilds_col'] = 'Famiglia';
...
$MESSAGE['interface']['administration']['items']['fit_in']['bag'] = 'Equipaggia';
...
$MESSAGE['interface']['administration']['items']['heal'] = 'Recupero salute';
...
$MESSAGE['interface']['administration']['items']['list_obj'] = 'Elenco oggetti richiesti da approvare';
...
$MESSAGE['interface']['administration']['guilds']['link']['jobs'] = 'Gestici le famiglie indipendenti';
$MESSAGE['interface']['administration']['guilds']['link']['new'] = 'Crea una nuova ' . strtolower($PARAMETERS['names']['guild_name']['sing']) . '';
$MESSAGE['interface']['administration']['guilds']['link']['new_role'] = 'Gestisci le famiglie indipendenti';
...
$MESSAGE['interface']['administration']['guilds']['jobs'] = 'Famiglie indipendenti';
...
/*Mestieri*/
$MESSAGE['interface']['administration']['jobs']['page_name'] = 'Gestione ' . strtolower($PARAMETERS['names']['job_name']['plur']) . ' e ruoli';
$MESSAGE['interface']['administration']['jobs']['link']['jobs'] = 'Gestici i mestieri indipentendi';
$MESSAGE['interface']['administration']['jobs']['link']['new'] = 'Crea una nuova ' . strtolower($PARAMETERS['names']['job_name']['sing']) . '';
$MESSAGE['interface']['administration']['jobs']['link']['new_role'] = 'Gestisci i lavori indipendenti';
$MESSAGE['interface']['administration']['jobs']['link']['back'] = 'Torna all\'elenco';
$MESSAGE['interface']['administration']['jobs']['link']['menage_types'] = 'Gestione dei tipi...';
$MESSAGE['interface']['administration']['jobs']['submit']['insert'] = 'Crea';
$MESSAGE['interface']['administration']['jobs']['submit']['edit'] = 'Modifica';
$MESSAGE['interface']['administration']['jobs']['submit']['undo'] = 'Annulla';
$MESSAGE['interface']['administration']['jobs']['warning']['suppressed'] = 'Siamo spiacenti, ma il mestiere di cui facevi parte è stato chiuso.';
$MESSAGE['interface']['administration']['jobs']['jobs'] = 'Lavori indipendenti';
$MESSAGE['interface']['administration']['jobs']['name'] = 'Nome';
$MESSAGE['interface']['administration']['jobs']['image'] = 'Immagine';
$MESSAGE['interface']['administration']['jobs']['site'] = 'URL del sito';
$MESSAGE['interface']['administration']['jobs']['type'] = 'Tipo';
$MESSAGE['interface']['administration']['jobs']['type_err'] = 'Non è stato specificato alcun tipo per i mestieri.';
$MESSAGE['interface']['administration']['jobs']['visible'] = 'Visibile';
$MESSAGE['interface']['administration']['jobs']['role']['page_name'] = "Ruoli del mestiere";
$MESSAGE['interface']['administration']['jobs']['role']['name_new'] = "Nuovo ruolo";
$MESSAGE['interface']['administration']['jobs']['role']['name'] = "Ruolo";
$MESSAGE['interface']['administration']['jobs']['role']['pay'] = "Stipendio";
$MESSAGE['interface']['administration']['jobs']['role']['head'] = "Controlli di mestiere";
$MESSAGE['interface']['administration']['jobs']['role']['head_info'] = "I ruoli che hanno abilitati i controlli di mestiere possono nominare e rimuovere i membri ed altri privilegi.";
$MESSAGE['interface']['administration']['jobs']['role']['submit']['edit'] = 'Modifica';
$MESSAGE['interface']['administration']['jobs']['role']['submit']['delete'] = 'Elimina';
/*Tipi*/
...
/*Manuale*/
$MESSAGE['manuale']['tipo'][0] = 'Regolamento generale';
$MESSAGE['manuale']['tipo'][1] = 'Manuali di gioco';
$MESSAGE['manuale']['tipo'][2] = 'Manuali di combattimento';
$MESSAGE['manuale']['tipo'][3] = 'Staff';
$MESSAGE['manuale']['tipo'][4] = 'Ambientazione';
...
$MESSAGE['status_pg']['nooff'] = 'Non stai giocando in questa location! Non puoi scrivere OFF!';
$MESSAGE['status_pg']['stopoff'] = 'Hai scritto già 5 OFF. Non te ne sono consentiti altri per oggi!';
...
$MESSAGE['chat']['type'][8] = 'Moderatore';
$MESSAGE['chat']['type'][9] = 'Globale';
$MESSAGE['chat']['type'][10] = 'OFF';
$MESSAGE['chat']['type'][11] = 'Sussurro2';
...
$MESSAGE['chat']['whisper']['skill'] = 'Valutazione tiro';
...
/*VOLTI*/
$MESSAGE['volti']['elenco']['titolo'] = 'Patrocinio dei volti';
$MESSAGE['volti']['elenco']['m'] = 'Volti maschili';
$MESSAGE['volti']['elenco']['f'] = 'Volti femminili';

/*TIPOLOGIE SKILL*/

$MESSAGE['names']['skill']['1'] = 'Generica base';
$MESSAGE['names']['skill']['7'] = 'Generica avanzata';
$MESSAGE['names']['skill']['2'] = 'Default';
$MESSAGE['names']['skill']['3'] = 'Attacco base';
$MESSAGE['names']['skill']['8'] = 'Attacco medio';
$MESSAGE['names']['skill']['9'] = 'Attacco avanzato';
$MESSAGE['names']['skill']['4'] = 'Mentale base';
$MESSAGE['names']['skill']['10'] = 'Mentale media';
$MESSAGE['names']['skill']['11'] = 'Mentale avanzata';
$MESSAGE['names']['skill']['5'] = 'Difensiva';
$MESSAGE['names']['skill']['6'] = 'Talento';
$MESSAGE['names']['skill']['12'] = 'Potere speciale';
$MESSAGE['names']['skill']['13'] = 'Mentale di attacco';
...
/********** Ricorrenti **********/
/*Forms */
$MESSAGE['interface']['forums']['topic']['state'] = "Stato";
...
$MESSAGE['interface']['forms']['level_up'] = 'Potenzia lo spirito';
/*Paginatore*/
...
/********** Gruppi di messaggio **********/
    ...
    $MESSAGE['interface']['skill']['comfirmdel'] = 'Vuoi cancellare questa skill?';