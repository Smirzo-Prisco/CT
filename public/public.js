        ...
        try {
            ...
            if (res.success) {
                ...
                if (successBox) {
                    ...
                    setText("pubRegSuccessMestiere", res.mestiere_nome ?? "Nessuno");
