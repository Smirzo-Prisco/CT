...
if($_SESSION['login'] != '') {
    if(gdrcd_controllo_esilio($_SESSION['login']) === true) {
        ...
        if($PARAMETERS['mode']['log_back_location'] == 'OFF') {
            ...
            notifySocketServer('users:update',  'loc:-1'); // aggiorna OnlineUsers nella stessa stanza
            notifySocketServer('presenti:update', 'global'); // aggiorna PresentiEstesi su tutti i client
            ...
            notifySocketServer('users:update',  'loc:' . (int)$_SESSION['luogo']); // aggiorna OnlineUsers nella stessa stanza
            notifySocketServer('presenti:update', 'global'); // aggiorna PresentiEstesi su tutti i client
