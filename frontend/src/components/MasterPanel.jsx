        ...
        <div className="gdr-card">
            ...
            {selectedPg && !loading && (
                <>
                    ...
                    <button className="gdr-button" onClick={save} disabled={saving}>
        ...
        <div className="gdr-card">
            ...
            {pngList.length === 0 ? (
                ...
                <>
                    ...
                    <button className="gdr-button" onClick={sendAttack} disabled={sending}>
    ...
    return createPortal(
        <div
            ...
            style={{
                ...
                position: 'fixed',
                top:      0,
                left:     'var(--sidebar-modal-offset, 5%)',
                right:    'var(--sidebar-modal-offset, 5%)',
                bottom:   0,
                zIndex:   1001,
            }}
        >
                ...
                <div className="gdr-header">
                    ...
                    <div className="gdr-main-controls">
                        <a href="#" id="endTurnMaster" className="gdr-control-btn" title="Chiudi turno"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20" height="20" fill="#e8e6e3">
