...
//            } else {
                ...
                gdrcd_query("INSERT INTO personaggio (nome, cognome, pass, data_iscrizione, email, sesso, id_razza, id_mestiere, id_ruolo_mestiere, car0, car1, car2, car3, car4, car5, car6, car7, salute, salute_max, soldi, punto_razza, esperienza_mestiere, esperienza $lastpasschange_field) VALUES ('" . trim(gdrcd_capital_letter(gdrcd_filter('in', $_POST['nome']))) . "', '" . trim(gdrcd_filter('in', $_POST['cognome'])) . "', '" . gdrcd_encript($pass) . "', NOW(), '" . gdrcd_filter('in', $_POST['email']) . "', '" . gdrcd_filter('in', $_POST['genere']) . "', " . gdrcd_filter('num', $_POST['razza']) . ", " . gdrcd_filter('num', $lavoro) . ", " . gdrcd_filter('num', $_POST['mestiere']) . ", '10.0', '0', '10.0', '0', '10.0', '0', '10.0', '0', " . gdrcd_filter('num', $PARAMETERS['settings']['max_hp']) . ", " . gdrcd_filter('num', $PARAMETERS['settings']['max_hp']) . ", " . gdrcd_filter('num',  $PARAMETERS['settings']['first_money']) . ", '0.0', " . gdrcd_filter('num',  $PARAMETERS['settings']['first_px_job']) . ", " . gdrcd_filter('num',  $PARAMETERS['settings']['first_px']) . " $lastpasschange_value)");
