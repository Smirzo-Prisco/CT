...
$PARAMETERS['database']['username'] = 'crystaltokyo';            //nome utente del database
$PARAMETERS['database']['password'] = 'TAw*N97t';            //password del database
$PARAMETERS['database']['database_name'] = 'my_crystaltokyo';    //nome del database
...
$PARAMETERS['info']['site_url'] = 'https://crystaltokyo.altervista.org/'; //indirizzo URL del gioco
$PARAMETERS['info']['webmaster_name'] = 'Webmaster'; //nome e cognome del responsabile del sito
$PARAMETERS['info']['webmaster_email'] = 'crystaltokyo@altervista.org'; //email ufficiale del webmaster (è visibile in homepage)
...
$PARAMETERS['mode']['welcome_message_homepage'] = 'OFF';//Attiva il messaggio di bevenuto in homepage
...
/* SCELTA DEL TEMA */
//$PARAMETERS['themes']['current_theme'] = 'advanced'; //tema vecchio
$PARAMETERS['themes']['current_theme'] = 'crystal'; //tema in uso 
...
$PARAMETERS['names']['currency']['sing'] = 'Crystal Yen'; //nome singolare della valuta nel gioco
$PARAMETERS['names']['currency']['plur'] = 'Crystal Yen'; //nome plurale della valuta nel gioco
$PARAMETERS['names']['currency']['short'] = 'CY'; //nome breve della valuta nel gioco
$PARAMETERS['names']['private_message']['sing'] = 'SMS'; //nome dei messaggi privati tra utenti (singolare)
$PARAMETERS['names']['private_message']['plur'] = 'SMS'; //nome dei messaggi privati tra utenti (plurale)
$PARAMETERS['names']['private_message']['image_file'] = '../icone/icona_base_mex.png'; //immagine del link ai messaggi
$PARAMETERS['names']['private_message']['image_file_onclick'] = '../icone/icona_base_mex.png'; //immagine al passaggio del mouse dei messaggi
$PARAMETERS['names']['private_message']['image_file_new'] = '../icone/icon_day_newmex.gif'; //immagine nuovi messaggi
$PARAMETERS['names']['private_message']['image_file_new_night'] = '../icone/icon_night_new_mex.gif'; //immagine nuovi messaggi
...
$PARAMETERS['names']['guild_name']['sing'] = 'Famiglia'; //nome delle gilde nel gioco (singolare)
$PARAMETERS['names']['guild_name']['plur'] = 'Famiglie'; //nome delle gilde nel gioco (plurale)
...
$PARAMETERS['names']['job_name']['sing'] = 'Mestiere'; //nome delle gilde nel gioco (singolare)
$PARAMETERS['names']['job_name']['plur'] = 'Mestieri'; //nome delle gilde nel gioco (plurale)
$PARAMETERS['names']['job_name']['lead'] = 'Capomestiere'; //nome del capo gilda nel gioco (plurale)
$PARAMETERS['names']['job_name']['members'] = 'Membri'; //componenti della gilda (plurale)
$PARAMETERS['names']['job_name']['type'] = 'Allineamento'; //nome del tipo gilda nel gioco (singolare)
$PARAMETERS['names']['job_name']['statuto'] = 'Statuto'; //componenti della gilda (plurale)
$PARAMETERS['names']['race']['sing'] = 'Spirito'; //nome delle razze nel gioco (singolare)
$PARAMETERS['names']['race']['plur'] = 'Spiriti'; //nome delle razze nel gioco (plurale)
...
$PARAMETERS['names']['administrator']['sing'] = 'Coordinatore'; //titolo del super user (singolare)
$PARAMETERS['names']['administrator']['plur'] = 'Coordinatori'; //titolo del super user (plurale)
$PARAMETERS['names']['gamemenu']['menu'] = 'Menu'; //Nome in calce al menu del gioco
$PARAMETERS['names']['market_name'] = 'Mercato'; //Nome del mercato
$PARAMETERS['names']['maps_location'] = 'Mappa'; //Appare se il PG si trova su una mappa
...
$PARAMETERS['names']['stats']['car1'] = 'Forza di Gilda';
$PARAMETERS['names']['stats']['car2'] = 'Destrezza';
$PARAMETERS['names']['stats']['car3'] = 'Destrezza di Gilda';
$PARAMETERS['names']['stats']['car4'] = 'Mente';
$PARAMETERS['names']['stats']['car5'] = 'Mente di Gilda';
$PARAMETERS['names']['stats']['car6'] = 'Tempra';
$PARAMETERS['names']['stats']['car7'] = 'Tempra di Gilda';
$PARAMETERS['names']['stats']['hitpoints'] = 'Punti ferita';
$PARAMETERS['names']['stats']['notorieta'] = 'Notorietà';
$PARAMETERS['names']['agenda']['sing'] = 'Agenda';
...
$PARAMETERS['settings']['first_money'] = 1000;//Quantita' di denaro iniziale per i PG
...
$PARAMETERS['settings']['messages_per_page'] = 5;//Numero di messaggi visualizzati per pagina nel sistema di messaggistica privata
...
$PARAMETERS['settings']['jobs_limit'] = 1;//Numero massimo di gilde a cui si può essere affiliati. Il numero tiene conto dei mestieri di cui un personaggio è membro e dell'eventuale lavoro indipendente che svolte. In ogni caso il sistema permette di svolgere un unico lavoro indipendente. La paga giornaliera del personaggio e' la somma degli introiti di tutti i ruoli di mestiere e dell'eventuale lavoro che riveste.
$PARAMETERS['settings']['gilda_giocatore_limit'] = 1;//Numero massimo di gilde giocatore (tabella clgpersonaggioaffiliazione) a cui un personaggio può essere affiliato contemporaneamente. Scollegato da jobs_limit: un personaggio può avere sia un mestiere vero che una gilda insieme.
...
$PARAMETERS['settings']['first_px_job'] = 0;//Esperienza iniziale mestiere. Se il gioco non prevede abilità dovrebbe essere 0.
...
//OFF: disabilita l'uso dell'audio
//TODO: inserire un pulsante tipo campanella per abilitare l'autoplay su Safari
 ...
 * @author Blancks
 */
$PARAMETERS['settings']['audio_new_messagges'] = 'sms.wav';
...
$PARAMETERS['settings']['exp_by_chat']['number'] = '8000';
...
$PARAMETERS['mode']['chatsave_download'] = 'ON';
...
#$PARAMETERS['menu']['forum']['image_file'] = '../menu/bacheca_off.png';
#$PARAMETERS['menu']['forum']['image_file_onclick'] = '../menu/bacheca_off.png';
...
#$PARAMETERS['menu']['services']['text'] = 'Uffici';
#$PARAMETERS['menu']['services']['url'] = 'main.php?page=uffici';
#$PARAMETERS['menu']['services']['image_file'] = '../menu/uffici_off.png';
#$PARAMETERS['menu']['services']['image_file_onclick'] = '../menu/uffici_off.png';
...
#$PARAMETERS['menu']['manuali']['text'] = 'Manuali';
#$PARAMETERS['menu']['manuali']['url'] = 'documentazione_main.php" target="_blank"';
#$PARAMETERS['menu']['manuali']['image_file'] = '../menu/manuali_off.png';
#$PARAMETERS['menu']['manuali']['image_file_onclick'] = '../menu/manuali_off.png';

/*SECONDO MENU*/

$PARAMETERS['secondo_menu']['famiglie']['text'] = 'Famiglie';
$PARAMETERS['secondo_menu']['famiglie']['url'] = 'main.php?page=servizi_gilde';
$PARAMETERS['secondo_menu']['famiglie']['image_file'] = '../menu/famiglie_off.png';
$PARAMETERS['secondo_menu']['famiglie']['image_file_onclick'] = '../menu/famiglie_off.png';

$PARAMETERS['secondo_menu']['mestieri']['text'] = 'Mestieri';
$PARAMETERS['secondo_menu']['mestieri']['url'] = 'main.php?page=servizi_mestieri';
$PARAMETERS['secondo_menu']['mestieri']['image_file'] = '../menu/mestieri_off.png';
$PARAMETERS['secondo_menu']['mestieri']['image_file_onclick'] = '../menu/mestieri_off.png';

$PARAMETERS['secondo_menu']['ctnews']['text'] = 'CT News';
$PARAMETERS['secondo_menu']['ctnews']['url'] = '#';
$PARAMETERS['secondo_menu']['ctnews']['image_file'] = '../menu/ctnews_off.png';
$PARAMETERS['secondo_menu']['ctnews']['image_file_onclick'] = '../menu/ctnews_off.png';
$PARAMETERS['secondo_menu']['ctnews']['onclick'] = 'ctNews(\''.$_SESSION['login'].'\')';
...
$PARAMETERS['office']['jobs_adm']['text'] = "Amministrazione " . strtolower($PARAMETERS['names']['job_name']['sing']);
$PARAMETERS['office']['jobs_adm']['url'] = 'main.php?page=servizi_adm_mestieri';
$PARAMETERS['office']['jobs_adm']['access_level'] = USER;
$PARAMETERS['office']['job']['text'] = 'Scegli Lavoro';
$PARAMETERS['office']['job']['url'] = 'main.php?page=scegli_lavoro';
...
$PARAMETERS['office']['volto']['text'] = 'Patrocinio volti';
$PARAMETERS['office']['volto']['url'] = 'main.php?page=elenco_volti';
$PARAMETERS['office']['volto']['access_level'] = USER;
...
$PARAMETERS['office']['richiedi']['text'] = 'Richiedi Oggetto';
$PARAMETERS['office']['richiedi']['url'] = 'main.php?page=richiesta_oggetto';
$PARAMETERS['office']['richiedi']['access_level'] = USER;
...
$PARAMETERS['user']['rules']['text'] = 'Manuali';
$PARAMETERS['user']['rules']['url'] = 'user_regolamento.php';
$PARAMETERS['user']['rules']['access_level'] = USER;
$PARAMETERS['user']['rules']['target'] = '_blank';
...
$PARAMETERS['user']['level_up']['text'] = 'Aumenta livello spirito';
$PARAMETERS['user']['level_up']['url'] = 'main.php?page=level_up';
$PARAMETERS['user']['level_up']['access_level'] = USER;
$PARAMETERS['user']['stats_level_up']['text'] = 'Aumenta statistiche personaggio';
$PARAMETERS['user']['stats_level_up']['url'] = 'main.php?page=stats_level_up';
$PARAMETERS['user']['stats_level_up']['access_level'] = USER;
/* PANNELLO GESTIONE */
...
$PARAMETERS['administration']['skills']['text'] = 'Gestione abilità generiche';
...
$PARAMETERS['administration']['guild_skills']['text'] = 'Gestione abilità gilde';
$PARAMETERS['administration']['guild_skills']['url'] = 'main.php?page=gestione_abilita_gilde';
$PARAMETERS['administration']['guild_skills']['access_level'] = SUPERUSER;
...
$PARAMETERS['administration']['jobs']['text'] = 'Gestione mestieri e ruoli';
$PARAMETERS['administration']['jobs']['url'] = 'main.php?page=gestione_mestieri';
$PARAMETERS['administration']['jobs']['access_level'] = SUPERUSER;
$PARAMETERS['administration']['inclinazioni']['text'] = 'Gestione Inclinazione';
$PARAMETERS['administration']['inclinazioni']['url'] = 'main.php?page=gestione_inclinazione';
$PARAMETERS['administration']['inclinazioni']['access_level'] = SUPERUSER;
...
$PARAMETERS['administration']['erasepg']['text'] = 'Cancella personaggi inattivi';
$PARAMETERS['administration']['erasepg']['url'] = 'main.php?page=erase_pg';
$PARAMETERS['administration']['erasepg']['access_level'] = SUPERUSER;
$PARAMETERS['administration']['eraseinactive']['text'] = 'Cancella personaggi mai entrati';
$PARAMETERS['administration']['eraseinactive']['url'] = 'main.php?page=erase_inactive';
$PARAMETERS['administration']['eraseinactive']['access_level'] = SUPERUSER;
$PARAMETERS['administration']['erasepgsingle']['text'] = 'Cancella personaggio';
$PARAMETERS['administration']['erasepgsingle']['url'] = 'main.php?page=erasepg_scelta';
$PARAMETERS['administration']['erasepgsingle']['access_level'] = SUPERUSER;
$PARAMETERS['administration']['request_item']['text'] = 'Approva/Nega oggetti';
$PARAMETERS['administration']['request_item']['url'] = 'main.php?page=elenco_richieste_oggetti';
$PARAMETERS['administration']['request_item']['access_level'] = SUPERUSER;
$PARAMETERS['administration']['request_item']['text'] = 'Potenzia PNG';
$PARAMETERS['administration']['request_item']['url'] = 'main.php?page=punti_png';
$PARAMETERS['administration']['request_item']['access_level'] = GAMEMASTER;
