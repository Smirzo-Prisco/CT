...
try {
    ...
    $mail->Username   = 'marko.marrone@gmail.com';                 //SMTP username
    $mail->Password   = 'TAwN97t*';                //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;   //Abilita TLS implicito
    $mail->Port       = 587;                              //Porta SMTP

    //Recipients
    $mail->setFrom('user@gmail.com', 'User');
    $mail->addAddress('espositoclemente84@gmail.com', 'Dest');  //Indirizzo destinatario
