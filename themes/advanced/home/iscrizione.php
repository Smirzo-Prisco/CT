<div class="pagina_iscrizione">
                    ...
                    <form action="<?php echo $_SERVER['SCRIPT_NAME'] . '?' . $_SERVER['QUERY_STRING']; ?>"
                        ...
                        <div class="form_label">
                            <?php echo gdrcd_filter('out',
                                $PARAMETERS['names']['race']['sing'] . ' ' . $MESSAGE['register']['fields']['race']); ?>
                        </div>
            ...
            <div class="panels_box">
                ...
                <?php } else
                {
                    ...
                    <div class="elenco_gioco">
                        ...
                        <!-- adesso stampo i talenti in base allo spirito scelto -->
                        <?php
    ...
    //            } else {
                    ...
                    gdrcd_query("INSERT INTO personaggio (nome, cognome, pass, data_iscrizione, email, sesso, id_razza, car0, car1, car2, car3, car4, car5, car6, car7, salute, salute_max, soldi, punto_abilita, punto_razza, esperienza $lastpasschange_field) VALUES ('" . trim(gdrcd_capital_letter(gdrcd_filter('in', $_POST['nome']))) . "', '" . trim(gdrcd_filter('in', $_POST['cognome'])) . "', '" . gdrcd_encript($pass) . "', NOW(), '" . gdrcd_filter('in', $_POST['email']) . "', '" . gdrcd_filter('in', $_POST['genere']) . "', " . gdrcd_filter('num', $_POST['razza']) . ", '10.0', '0', '10.0', '0', '10.0', '0', '10.0', '0', " . gdrcd_filter('num', $PARAMETERS['settings']['max_hp']) . ", " . gdrcd_filter('num', $PARAMETERS['settings']['max_hp']) . ", " . gdrcd_filter('num',  $PARAMETERS['settings']['first_money']) . ", '0.0', '0.0', " . gdrcd_filter('num',  $PARAMETERS['settings']['first_px']) . " $lastpasschange_value)");
    ...
    //            }
                ...
                gdrcd_query("INSERT INTO messaggi (mittente, destinatario, spedito, testo) VALUES ('" . gdrcd_filter('out',
                        $PARAMETERS['info']['webmaster_name']) . "', '" . gdrcd_filter('get',
                        $_POST['nome']) . "', NOW(), '" . gdrcd_filter('out',
                        $MESSAGE['register']['welcome']['message'][4]) . "')");
