...
<tr class="second_header">
<td>
<a href="#dialog3" name="modal3"><center>CARICHE</center></a>
</td>
</tr>
...
<tr class="second_header">
<td>
<a href="#dialog4" name="modal4"><center>NOTORIET&Agrave;</center></a>
</td>
</tr>
...
<div id="box"> 
    ...
    <div id="box"> 
     ...
     <div id="box"> 
		<div id="dialog3" class="window"> 
			<p class="titoletti">Cariche</p><br /><br /> 
    ...
    <div id="box"> 
		<div id="dialog4" class="window"> 
			<p class="titoletti">Notoriet&agrave;</p><br /><br /> 
