    ...
    <div class="page_body">
        <div class="panels_box">
            ...
            //Determinazione pagina (paginazione)
                ...
                $record_globale = gdrcd_query("SELECT COUNT(*) FROM Punti WHERE nome = '" . gdrcd_filter('in',
                        $_REQUEST['pg']) . "'");
                    ...
                    { 
                     ...
                     ?>
                        ...
                        <tr>
                            ...
                            <td class="casella_elemento">
                                <div class="elementi_elenco"><?php echo gdrcd_filter('out', 
                                        $record['esperienza']); ?></div>
                            </td>
                            
                            <td class="casella_elemento">
                                <div class="elementi_elenco"><?php echo gdrcd_filter('out', 
                                        $record['notorieta']); ?></div>
                            </td>
                ...
                <div class="pager">
                    <?php if ($totaleresults > $PARAMETERS['settings']['view_logs'])
                    {
                        ...
                        for ($i = 0; $i <= floor($totaleresults / $PARAMETERS['settings']['view_logs']); $i++)
                        {
                            ...
                            {
                                ?>
                                <a href="main.php?page=scheda_px&pg=<?php echo $_REQUEST['pg']; ?>&offset=<?php echo $i; ?>"><?php echo $i + 1; ?></a>
                            <?php } else
                            {
                                echo ' ' . ($i + 1) . ' ';
                            }
