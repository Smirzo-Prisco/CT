        ...
        if(isset($_POST['op']) === true) {
            ...
            if($_POST['op'] == 'update') {
                ...
                if($_FILES['img_oggetto']['name'] == '') {
                    ...
                    gdrcd_query("UPDATE oggetto SET tipo=".gdrcd_filter('in', $_POST['tipo_oggetto']).", nome='".gdrcd_filter('in', $_POST['nome_oggetto'])."', urlimg='".gdrcd_filter('in', $immagine_oggetto)."', descrizione='".gdrcd_filter('in', $_POST['descrizione_oggetto'])."', costo=".gdrcd_filter('num', $_POST['costo_oggetto']).", ubicabile=".gdrcd_filter('num', $_POST['fit_in']).", attacco=".gdrcd_filter('num', $_POST['attacco_oggetto']).", difesa=".gdrcd_filter('num', $_POST['difesa_oggetto']).", cariche=".gdrcd_filter('num', $_POST['cariche_oggetto']).", heal=".gdrcd_filter('num', $_POST['heal']).", bonus_car0=".gdrcd_filter('num', $_POST['car0_oggetto']).", bonus_car1=".gdrcd_filter('num', $_POST['car1_oggetto']).", bonus_car2=".gdrcd_filter('num', $_POST['car2_oggetto']).", bonus_car3=".gdrcd_filter('num', $_POST['car3_oggetto']).", bonus_car4=".gdrcd_filter('num', $_POST['car4_oggetto']).", bonus_car5=".gdrcd_filter('num', $_POST['car5_oggetto']).", bonus_car1_extra=".gdrcd_filter('num', $_POST['bonus_car1_extra']).", bonus_car2_extra=".gdrcd_filter('num', $_POST['bonus_car2_extra']).", bonus_car3_extra=".gdrcd_filter('num', $_POST['bonus_car3_extra']).", isTemp=".gdrcd_filter('num', $_POST['isTemp'])." WHERE id_oggetto=".gdrcd_filter('num', $_POST['id_oggetto'])."");
    ...
    else
    {
        ...
        ################################
            ...
            if(gdrcd_filter('get', $_POST['op']) == 'insert') {
                ...
                $data_scadenza = $_POST['data_scadenza'] == '' ? '0000-00-00 00:00:00' : $_POST['data_scadenza'];
                
                gdrcd_query("INSERT INTO oggetto (tipo, nome, urlimg, descrizione, costo, ubicabile, attacco, difesa, cariche, heal, bonus_car0, bonus_car1, bonus_car2, bonus_car3, bonus_car4, bonus_car5, creatore, data_inserimento, bonus_car1_extra, bonus_car2_extra, bonus_car3_extra, isTemp, data_scadenza) VALUES (".gdrcd_filter('in', $_POST['tipo_oggetto']).", '".gdrcd_filter('in', $_POST['nome_oggetto'])."', '".gdrcd_filter('in', $immagine_oggetto)."', '".gdrcd_filter('in', $_POST['descrizione_oggetto'])."', ".gdrcd_filter('num', $_POST['costo_oggetto']).", ".gdrcd_filter('num', $_POST['fit_in']).", ".gdrcd_filter('num', $_POST['attacco_oggetto']).", ".gdrcd_filter('num', $_POST['difesa_oggetto']).", ".gdrcd_filter('num', $_POST['cariche_oggetto']).", ".gdrcd_filter('num', $_POST['heal']).", ".gdrcd_filter('num', $_POST['car0_oggetto']).", ".gdrcd_filter('num', $_POST['car1_oggetto']).", ".gdrcd_filter('num', $_POST['car2_oggetto']).", ".gdrcd_filter('num', $_POST['car3_oggetto']).", ".gdrcd_filter('num', $_POST['car4_oggetto']).", ".gdrcd_filter('num', $_POST['car5_oggetto']).", '".$_SESSION['login']."', NOW(), ".gdrcd_filter('num', $_POST['bonus_car1_extra']).", ".gdrcd_filter('num', $_POST['bonus_car2_extra']).", ".gdrcd_filter('num', $_POST['bonus_car3_extra']).", ".gdrcd_filter('num', $_POST['isTemp']).", '$data_scadenza')");
        ...
        <div class="panels_box">
            ...
            <form class="form_gestione" action="main.php?page=gestione_mercato" method="post" enctype="multipart/form-data">
                <div class='form_label'>
                ...
                <div class='form_label'>
                    <?php echo "Data scadenza"?>
                </div>
                <div class='form_field'>
                    <input type="datetime-local" name="data_scadenza" value="<?php echo $loaded_item['data_scadenza']; ?>" />
                </div>
                <div class='form_label'>
                    <?php echo "Temp " . gdrcd_filter('out', $MESSAGE['interface']['administration']['items']['item_bonus']).' '.gdrcd_capital_letter(gdrcd_filter('out', $PARAMETERS['names']['stats']['car0'])); ?>
                </div>
                <div class='form_field'>
                    <input type="text" name="bonus_car1_extra" value="<?php echo (int) $loaded_item['bonus_car0_extra']; ?>" />
                </div>
				<div class='form_label'>
                    <?php echo "Temp " . gdrcd_filter('out', $MESSAGE['interface']['administration']['items']['item_bonus']).' '.gdrcd_capital_letter(gdrcd_filter('out', $PARAMETERS['names']['stats']['car2'])); ?>
                </div>
                <div class='form_field'>
                    <input type="text" name="bonus_car2_extra" value="<?php echo (int) $loaded_item['bonus_car2_extra']; ?>" />
                </div>   
                <div class='form_label'>
                    <?php echo "Temp " . gdrcd_filter('out', $MESSAGE['interface']['administration']['items']['item_bonus']).' '.gdrcd_capital_letter(gdrcd_filter('out', $PARAMETERS['names']['stats']['car4'])); ?>
                </div>
                <div class='form_field'>
                    <input type="text" name="bonus_car3_extra" value="<?php echo (int) $loaded_item['bonus_car3_extra']; ?>" />
                </div>
                <div class='form_label'>
                    <?php echo "Temp " . gdrcd_filter('out', $MESSAGE['interface']['administration']['items']['item_bonus']).' '.gdrcd_capital_letter(gdrcd_filter('out', $PARAMETERS['names']['stats']['car6'])); ?>
                </div>
                <div class='form_field'>
