    ...
    <div class="page_body">
            ...
            <div class="background"><!-- Background, affetti, robe varie -->
                <div class="titolo_box">
                    <?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['box_title']['off']); ?>
                </div>
                <div class="body_box">
                    <?php
                    ...
                    if($PARAMETERS['mode']['user_bbcode'] == 'ON') {
                        if($PARAMETERS['settings']['user_bbcode']['type'] == 'bbd' && $PARAMETERS['settings']['bbd']['free_html'] == 'ON') {
                            ...
                            echo bbdecoder(gdrcd_filter('out', $personaggio['off']), true);
                        } else {
                            echo gdrcd_bbcoder(gdrcd_filter('out', $personaggio['off']));
                        }
                    } else {
