                    ...
                    <table class="customTable">
                        ...
                        while($row = gdrcd_query($result, 'fetch')) {
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <img src="imgs/races/<?php echo gdrcd_filter('out', $row['immagine']); ?>" />
                                    </div>
                                </td>
                                <td>
                                    <div>
            ...
            $query = "SELECT * FROM razza WHERE id_razza >= ".$tot_razza." AND id_razza < ".($tot_razza + 99)." ORDER BY id_razza ASC";            $result = gdrcd_query($query, 'result'); ?>
                    ...
                    <table class="customTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <img src="imgs/races/<?php echo gdrcd_filter('out',
                                                                                                                                                                    $row['immagine']
                                    ); ?>" />
                                </div>
                            </td>
...
<?php $id_img_razza = $row['id_razza'];
 ...
 ?>
                                    ...
                                    <img src="imgs/races/<?php echo gdrcd_filter('out', $row_razza['immagine']); ?>" />
                                </div>
                            </td>
                            <td>
                                <div>
