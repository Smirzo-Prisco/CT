...
<?php   /********** Categoria ARMA  ************/
        if ($oggetto['categoria'] === 'arma') { ?>
            <!-- Tipo di arma -->
            <tr class="second_header"><td><b>Tipo di arma</b></td></tr>
            <tr>
                <td>
            ...
            <!-- Bonus arma -->
            <tr class="second_header"><td><b>Bonus arma</b></td></tr>
            <tr>
                <td>
            ...
            <!-- Ricarica massima -->
            <tr class="second_header"><td><b>Ricarica massima</b></td></tr>
            <tr>
                <td>
...
<?php
        ...
        /********** Categoria CURATIVO  ************/
        if ($oggetto['categoria'] === 'curativo') { ?>
            <!-- Quanta salute integra -->
            <tr class="second_header"><td><b>Quanta salute integra</b></td></tr>
            <tr>
                <td>
            ...
            <tr class="second_header"><td><b>Quanta integrità integra</b></td></tr>
            <tr>
                <td>
            ...
            <!-- Cariche iniziali -->
            <tr class="second_header"><td><b>Cariche iniziali</b></td></tr>
            <tr>
                <td>
        ...
        if ($oggetto['categoria'] === 'statistica') { ?>
            <!-- Durata (in giorni) -->
            <tr class="second_header"><td><b>Durata (in giorni)</b></td></tr>
            <tr>
                <td>
...
<?php
        ...
        /********** Categoria STANDARD  ************/
        if ($oggetto['categoria'] === 'standard') { ?>
            <!-- Utilizzo (non ricaricabile) -->
            <tr class="second_header"><td><b>Utilizzo</b></td></tr>
            <tr>
                <td>
                    <select name="cariche" class="ares">
