        ...
        if (isset($_POST['op']) === true)
        {
            ...
            if ((gdrcd_filter('get', $_REQUEST['pg']) == $_SESSION['login']) && (gdrcd_filter('get',$_POST['op']) == 'modify'))
            {
                ...
                gdrcd_query("UPDATE personaggio SET cognome = '" . gdrcd_filter('in',
                        $_POST['modifica_cognome']) . "', volto = '" . $modifica_volto . "', affetti = '" . $modifica_affetti . "', storia = '" . $modifica_background . "', principale = '" . $modifica_principale . "', off = '" . $modifica_off . "', descrizione = '" . $modifica_descrizione . "', 
                ...
                if ($_SESSION['login'] == $_REQUEST['pg'])
                {
                    ...
                    <div class="form_gioco">
                        ...
                        <form action="main.php?page=scheda_modifica" method="post">
                            ...
                            <tr>
                            <td>
                                <input type="text" name="modifica_volto"
                            ...
                            <td>
                                ...
                                <td>
                                    <input type="text" name="online_state" class="form_input"
                                           ...
                                           placeholder="Max 25 caratteri" maxlength="25"/>
                                </td>
                                </tr>
                                <?php
                            }
