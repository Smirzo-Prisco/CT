...
<?php
   ...
   // rilevamento doppi account (main.php?page=log&tab=doppi) — cancellarli insieme al
   // personaggio cancellerebbe anche l'evidenza che servirebbe a riconoscerlo se
   // tornasse con un nuovo personaggio dallo stesso IP.
