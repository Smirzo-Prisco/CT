...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['post-textarea'])) {
    ...
    $update_lettura_query_login = "
        ...
        $redirect_url = "tokyobook_mobile.php?tipo=" . $tipo;
...
<head>
    ...
    <link href="../themes/crystal/tokyobook_mobile.css" rel="stylesheet" type="text/css">
...
foreach ($categories as $category_key => $category_name) {
    ...
    $category_link = "tokyobook_mobile.php?tipo=" . $category_key;
...
if ($post_originale) {
    ...
    ?>
        ...
        <div class="back-button-container">
             <button onclick="window.location.href='tokyobook_mobile.php?tipo=<?php echo $tipo; ?><?php echo ($tipo == 'pagina_personale') ? '&pg=' . $nome_pg : ''; ?>';">
...
<?php } ?>
    ...
    <div class="post" id="post-<?php echo $post['id_messaggio']; ?>">
        ...
        <div class="post-reactions">
            ...
            <div class="reaction">
                 <span onclick="window.location.href='tokyobook_mobile.php?tipo=<?php echo $tipo; ?><?php echo ($tipo == 'pagina_personale') ? '&pg=' . $nome_pg : ''; ?>&post_id=<?php echo $post['id_messaggio']; ?>';">
...
function cambiaPagina() {
    ...
    var url = 'tokyobook_mobile.php?tipo=' + tipo + (pg ? '&pg=' + pg : '') + '&pagina=' + pagina;
