...
<div class="panels_box">
        ...
        <form class="form_messaggi" action="../../main.php?page=messages_center" method="post">
			...
			<div class='form_label'>
				...
				<div class='form_field'>
					<select name="ctgroup" required>
                    <?php if($_SESSION['admin'] == 1){ ?>
						<option value='GLOBAL'>Globale</option>
                    <?php } ?>
                       <option value='ONLINE'>Tutti i presenti</option>
                       <option value='CAPOGILDA'>Tutti i capogilda</option>
                       <option value='GILDA'>Tutta la famiglia</option>
					</select>
				</div>
                ...
                <!-- Per gruppo globale: aggiungi automaticamente membri mancanti -->
						...
						<div class='form_field'>
							<input type="checkbox" name="fladdusers" class="form_input" style="width: 50px;" />
						</div>	
					<br>
			<?php } else {  ?>
			<?php }   ?>
			...
			<div class='form_field'>
				<input type="hidden" name="dsgruppo" />
			</div>	
