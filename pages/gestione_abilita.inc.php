    ...
    if($_SESSION['admin']!=1) {
        ...
        <div class="page_body">
            ...
            if($_POST['op'] == 'insert') {
                ...
                gdrcd_query("INSERT INTO abilita (nome, descrizione, max_lvl, id_razza) VALUES ('".gdrcd_filter('in', $_POST['nome'])."', '".gdrcd_filter('in', $_POST['descrizione'])."', '3', ".gdrcd_filter('num', $_POST['id_razza']).")");
                ?>
                <div class="warning">
            ...
            if(gdrcd_filter('get', $_POST['op']) == 'modify') {
                ...
                gdrcd_query("UPDATE abilita SET nome ='".gdrcd_filter('in', $_POST['nome'])."', descrizione ='".gdrcd_filter('in', $_POST['descrizione'])."', max_lvl = ".gdrcd_filter('num', $_POST['max_lvl']).", id_razza = ".gdrcd_filter('num', $_POST['id_razza'])." WHERE id_abilita = ".gdrcd_filter('num', $_POST['id_record'])." LIMIT 1"); ?>
                <div class="warning">
                    ...
                    <form action="main.php?page=gestione_abilita" method="post" class="form_gestione">
                        ...
                        <div class='form_field'>
                            <select name='id_razza'>
                                ...
                                <?php
                                $result = gdrcd_query("SELECT id_razza, nome_razza FROM razza WHERE visibile = 1 ORDER BY nome_razza", 'result');
            ...
            if(isset($_REQUEST['op']) === false) { /*Elenco record (Visualizzaione di base della pagina)*/
                ...
                //Lettura record
                $result = gdrcd_query("SELECT id_abilita, nome, max_lvl, id_razza FROM abilita WHERE tipo = 'Talento' ORDER BY id_abilita LIMIT ".$pagebegin.", ".$pageend."", 'result');
                    ...
                    <div class="elenco_record_gestione">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo 'Spirito'; ?></div>
                                </td>
                                <td class="casella_titolo">
