...
<div class="pagina_user_cambio_pass">
    ...
    <!-- Box principale -->
    <div class="page_body" style="font-family: DejaVu Sans; font-size:12px; color: #8f8f8f;">
        ...
        if(isset($_POST['op']) === false) { ?>
            <div class="panels_box" style="font-family: DejaVu Sans; font-size:13px; color:#8f8f8f;">
            ...
            <?php
                ...
                <!-- link back -->
            <div class="link_back">
                <a href="main.php?page=uffici">
                    <br><?php echo "Torna indietro"; ?>
                </a>
            </div>
</div><!-- Box principale -->
