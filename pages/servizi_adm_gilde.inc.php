    ...
    <div class="page_body">
        ...
        if(isset($_POST['op']) === false) {
            echo '<div class="form_gioco">';
                ...
                $affiliazioni = "SELECT gilda.id_gilda, ruolo.nome_ruolo, gilda.nome, ruolo.id_ruolo FROM ruolo LEFT JOIN gilda ON gilda.id_gilda = ruolo.gilda WHERE ruolo.id_ruolo IN (SELECT id_ruolo FROM clgpersonaggioruolo WHERE personaggio = '".$_SESSION['login']."' AND scadenza < NOW()) ";
        ...
        if(gdrcd_filter('get', $_POST['op']) == 'hire') {
            ...
            if($jobs['COUNT(*)'] >= $PARAMETERS['settings']['guilds_limit']) {
                ...
                $gilda = "SELECT gilda FROM ruolo WHERE id_ruolo = ".$subject[0]."";
...
*/
            ...
            /*Rimuovo le stats*/
            gdrcd_query("UPDATE personaggio SET car0=car0-car1 WHERE nome = '".$subject[0]."'");
            gdrcd_query("UPDATE personaggio SET car2=car2-car3 WHERE nome = '".$subject[0]."'");
            gdrcd_query("UPDATE personaggio SET car4=car4-car5 WHERE nome = '".$subject[0]."'");
            gdrcd_query("UPDATE personaggio SET car1=0 WHERE nome = '".$subject[0]."'");
            gdrcd_query("UPDATE personaggio SET car3=0 WHERE nome = '".$subject[0]."'");
            gdrcd_query("UPDATE personaggio SET car5=0 WHERE nome = '".$subject[0]."'");
            ?>
