    ...
    if($_SESSION['admin']!=1) {
        ...
        <div class="page_body">
            ...
            if($_POST['op'] == 'insert') {
                ...
                gdrcd_query("INSERT INTO razza (nome_razza, sing_m, sing_f, descrizione, visibile, iscrizione, immagine, icon, url_site) VALUES ('".gdrcd_filter('in', $_POST['nome'])."', '".gdrcd_filter('in', $_POST['sing_m'])."', '".gdrcd_filter('in', $_POST['sing_f'])."', '".gdrcd_filter('in', $_POST['descrizione'])."', ".$is_visible.", ".$is_available.", '".gdrcd_filter('in', $immagine_oggetto)."', '".gdrcd_filter('in', $immagine_oggetto)."', '".gdrcd_filter('in', $_POST['url_site'])."')");
                upload_image();
                ?>
                <div class="warning">
            ...
            if((gdrcd_filter('get', $_POST['op']) == 'edit') || (gdrcd_filter('get', $_REQUEST['op']) == 'new')) {
                ...
                <div class="panels_box">
                    <div class="form_gestione">
                        <form action="main.php?page=gestione_razze" method="post" enctype="multipart/form-data">
                            ...
                            <div class='form_field'>
                                <input type="file" name="img_oggetto" value="<?php echo $loaded_item['immagine']; ?>" />
                            </div>
