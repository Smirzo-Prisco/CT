...
if (gdrcd_query($query_tae, 'num_rows') > 0) {
    ...
    $category_link = "main.php?page=tokyobook&tipo=" . $category_key . "&pg=" . $nome_pg;
            ...
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                if (results.length > 0) {
                 ...
                 '<div class="search-info">' +
                    ...
                    '<a href="main.php?page=tokyobook&tipo=pagina_personale&pg=' + result.nome + '" class="search-link">Visita Profilo</a>' +
                 '</div>';
