...
?>
  ...
  <div class="slides">
    <div id="slide-1">
<?php
include ('index_off.inc.php');
?>
    </div>
    <div id="slide-2">
<?php
include ('index_on.inc.php');
?>
    </div>
    <div id="slide-3">
<?php
include ('index_staff.inc.php');
?>
    </div>
  </div>
</div>
...
<td valign="top" align="center">
    <form onSubmit="return Conferma();" method="post" action="/pages/messages/eraseall.inc.php" target="readMessage">
        <input style="margin-top: 0xp; margin-bottom: 0px;" type="submit" value="Cancella tutti OFF">
        <input type="hidden" name="op" value="erase_off" />
    </form>
    </td>
<!-- link cancella on -->
    <td valign="top" align="center">
    <form onSubmit="return Conferma();" method="post" action="/pages/messages/eraseall.inc.php" target="readMessage">
        <input style="margin-top: 0xp; margin-bottom: 0px;" type="submit" value="Cancella tutti ON">
        <input type="hidden" name="op" value="erase_on" />
    </form>
    </td>
<!-- link cancella staff -->
    <td valign="top" align="center">
    <form onSubmit="return Conferma();" method="post" action="/pages/messages/eraseall.inc.php" target="readMessage">
        <input style="margin-top: 0xp; margin-bottom: 0px;" type="submit" value="Cancella tutti STAFF">
        <input type="hidden" name="op" value="erase_staff" />
    </form>
    </td>
    </tr>
    </table>
