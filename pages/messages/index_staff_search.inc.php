...
?>
    ...
    if($numresults > 0) { ?>
        <table class="customTable">
            ...
            while($row = gdrcd_query($result, 'fetch')) {
                ...
                <tr>
                    <td>
                        <input type="checkbox" class="message_check_staff" value="<?php echo (int) $row['id'] ?>" />
                    </td>
                    <td>
                        <div>
                            <?php
        ...
        <?php
        echo '<div>
          <form id="multiple_delete_staff" method="post" action="main.php?page=messages_center" onSubmit="return checked_copy_staff();">
    ...
    <div class="pager">
        ...
        if($totaleresults > $PARAMETERS['settings']['messages_per_page']) {
            ...
            <option value="main.php?page=messages_center&offset=<?php echo $i; ?>"><?php echo $i + 1; ?></option>                <?php } else {
                    echo ' '.($i + 1).' ';
                }
            }
            echo '</select>';
