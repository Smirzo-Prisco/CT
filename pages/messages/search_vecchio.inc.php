...
#echo "<script type='text/javascript'>alert('".$ricerca."');</script>";
...
if($_GET['op'] == 'inviati') {
    $result = gdrcd_query("SELECT * FROM messaggi WHERE mittente = '".$_SESSION['login']."' AND mittente_del = 0 AND tipo = 'off' AND (titolo LIKE '%$ricerca%' OR mittente LIKE '%$ricerca%' OR testo LIKE '%$ricerca%') ORDER BY spedito DESC LIMIT ".$pagebegin.", ".$pageend."", 'result');
    $record = gdrcd_query("SELECT COUNT(*) FROM messaggi WHERE mittente = '".$_SESSION['login']."' AND mittente_del = 0 AND tipo = 'off'");
    $delType = 'mittente_del';
    $totaleresults = $record['COUNT(*)'];

} else {
    $result = gdrcd_query("SELECT * FROM messaggi WHERE destinatario = '".$_SESSION['login']."' AND tipo = 'off' AND (titolo LIKE '%$ricerca%' OR mittente LIKE '%$ricerca%' OR testo LIKE '%$ricerca%') AND destinatario_del = 0 ".$extracond." ORDER BY spedito DESC LIMIT ".$pagebegin.", ".$pageend."", 'result');
    $record = gdrcd_query("SELECT COUNT(*) FROM messaggi WHERE destinatario = '".$_SESSION['login']."' AND tipo = 'off' AND destinatario_del = 0 ".$extracond."");
            ...
            while($row = gdrcd_query($result, 'fetch')) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                            <a href="main.php?page=messages_center&op=read&id_messaggio=<?php echo $row['id'] ?>"><?php echo gdrcd_filter('out', substr($row['titolo'], 0, 40)); ?>
...
//Elenco messaggi paginato OFF
if($_GET['op'] == 'inviati') {
    $result = gdrcd_query("SELECT * FROM messaggi WHERE mittente = '".$_SESSION['login']."' AND mittente_del = 0 AND tipo = 'on' AND (titolo LIKE '%$ricerca%' OR mittente LIKE '%$ricerca%' OR testo LIKE '%$ricerca%') ORDER BY spedito DESC LIMIT ".$pagebegin.", ".$pageend."", 'result');
    $record = gdrcd_query("SELECT COUNT(*) FROM messaggi WHERE mittente = '".$_SESSION['login']."' AND mittente_del = 0 AND tipo = 'on'");
    $delType = 'mittente_del';
    $totaleresults = $record['COUNT(*)'];

} else {
    $result = gdrcd_query("SELECT * FROM messaggi WHERE destinatario = '".$_SESSION['login']."' AND tipo = 'on' AND (titolo LIKE '%$ricerca%' OR mittente LIKE '%$ricerca%' OR testo LIKE '%$ricerca%') AND destinatario_del = 0 ".$extracond." ORDER BY spedito DESC LIMIT ".$pagebegin.", ".$pageend."", 'result');
...
//Elenco messaggi paginato OFF
if($_GET['op'] == 'inviati') {
    $result = gdrcd_query("SELECT * FROM messaggi WHERE mittente = '".$_SESSION['login']."' AND mittente_del = 0 AND tipo = 'staff' AND (titolo LIKE '%$ricerca%' OR mittente LIKE '%$ricerca%' OR testo LIKE '%$ricerca%') ORDER BY spedito DESC LIMIT ".$pagebegin.", ".$pageend."", 'result');
    $record = gdrcd_query("SELECT COUNT(*) FROM messaggi WHERE mittente = '".$_SESSION['login']."' AND mittente_del = 0 AND tipo = 'staff'");
    $delType = 'mittente_del';
    $totaleresults = $record['COUNT(*)'];

} else {
    $result = gdrcd_query("SELECT * FROM messaggi WHERE destinatario = '".$_SESSION['login']."' AND tipo = 'staff' AND (titolo LIKE '%$ricerca%' OR mittente LIKE '%$ricerca%' OR testo LIKE '%$ricerca%') AND destinatario_del = 0 ".$extracond." ORDER BY spedito DESC LIMIT ".$pagebegin.", ".$pageend."", 'result');
    $record = gdrcd_query("SELECT COUNT(*) FROM messaggi WHERE destinatario = '".$_SESSION['login']."' AND tipo = 'staff' AND destinatario_del = 0 ".$extracond."");
    $delType = 'destinatario_del';
    $totaleresults = $record['COUNT(*)'];
}
