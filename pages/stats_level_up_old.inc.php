...
$info_pg = gdrcd_query("SELECT esperienza, esperienza_r, car0, car1, car2, car3, car4, car5, car6, car7 FROM personaggio WHERE nome='".gdrcd_filter('in', $_SESSION['login'])."'");
...
$stats_gilda = $info_pg['car1'] + $info_pg['car3']+ $info_pg['car5'] + $info_pg['car7'];
$tot_stats_ruolo = $livello_ruolo_gilda * 40;
...
if((gdrcd_filter('get', $_REQUEST['op']) == 'addstat') && (($_SESSION['login'] == gdrcd_filter('out', $_REQUEST['pg'])) || ($_SESSION['admin']==1 || $_SESSION['moderatore']==2))) {
	...
	if($remaining >=1){}
	//vedo se può
           if ($somma_stats <= $remaining) {
           $query = "UPDATE personaggio SET car0 = car0 + ".$_POST['car0'].", car1 = car1 + ".$_POST['car0'].", car2 = car2 + ".$_POST['car2'].", car3 = car3 + ".$_POST['car2'].", car4 = car4 + ".$_POST['car4'].", car5 = car5 + ".$_POST['car4'].", car6 = car6 + ".$_POST['car6'].", car7 = car7 + ".$_POST['car6']." WHERE nome = '".gdrcd_filter('get', $_SESSION['login'])."'";
           gdrcd_query($query);
           echo "<script type='text/javascript'>alert('Parametri aggiornati!');</script>";
           } else {
           echo "<script type='text/javascript'>alert('Non hai abbastanza punti! Riprova!');</script>";
