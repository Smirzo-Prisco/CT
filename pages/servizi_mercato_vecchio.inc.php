<div class="pagina_servizi_mercato">
    ...
    <div class="page_body">
        ...
        if($_POST['op'] == 'buy') {
            ...
            $costo = gdrcd_query("SELECT * FROM oggetto WHERE id_oggetto = ".gdrcd_filter('num', $_POST['id_oggetto'])."");
            ...
            if($money >= $costo['costo']) {
                ...
                if(gdrcd_query($result, 'num_rows') > 0) {
                    ...
                    $query = "INSERT INTO clgpersonaggiooggetto (nome, id_oggetto, cariche, numero, posizione, isTemp, temp_giorni) VALUES ('".$_SESSION['login']."',".gdrcd_filter('num', $_POST['id_oggetto']).", ".$costo['cariche'].", 1, 0, ".gdrcd_filter('num', $_POST['isTemp']).", ".gdrcd_filter('num', $_POST['temp_giorni']).")";
                }
                /*Eseguo l'acquisto*/
                gdrcd_query($query);
                /*Esigo il quattrino*/
                            ...
                            <tr>
                                <td class="casella_elemento_img">
                                    ...
                                    <div class="inventario_img">
                                        <img src="imgs/items/<?php echo $row['urlimg']; ?>" />
                                    </div>
                                    ...
                                    <div class="controlli_elenco">
                                        <div class="form_gioco">
                                            <form action="main.php?page=servizi_mercato" method="post">
                                                ...
                                                <input type="hidden" name="isTemp" value="<?php echo $row['isTemp'] ?>" />
                                                <input type="hidden" name="temp_giorni" value="<?php echo $row['temp_giorni'] ?>" />
                                                ...
                                                <?php if($money < $row['costo']) {
                                                            echo 'Non hai abbastanza CTY';
                                                        } else { ?>
                                                    <input type="submit" name="butt" value="<?php echo gdrcd_filter('out', $MESSAGE['interface']['market']['buy']); ?>" />
                                                <?php } ?>
                                                </div>
                                            </form>
                                        </div>
