...
$PARAMETERS['names']['guild_name']['sing'] = 'Via'; //nome delle gilde nel gioco (singolare)
$PARAMETERS['names']['guild_name']['plur'] = 'Vie'; //nome delle gilde nel gioco (plurale)
$PARAMETERS['names']['corrente_name']['sing'] = 'Corrente'; //nome delle gilde nel gioco (singolare)
$PARAMETERS['names']['corrente_name']['plur'] = 'Correnti'; //nome delle gilde nel gioco (plurale)
...
$PARAMETERS['names']['stats']['car8'] = 'Potere';
$PARAMETERS['names']['stats']['car9'] = 'Potere di Gilda';
$PARAMETERS['names']['stats']['hitpoints'] = 'Punti ferita';
$PARAMETERS['names']['stats']['integrita'] = 'Punti integrità';
