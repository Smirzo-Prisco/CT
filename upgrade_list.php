...
$tables['personaggio']['suono_dm']     = "tinyint(1) NOT NULL DEFAULT '1'";
$tables['personaggio']['suono_chat']   = "tinyint(1) NOT NULL DEFAULT '1'";
$tables['personaggio']['suono_scheda'] = "tinyint(1) NOT NULL DEFAULT '1'";
